...
function target(ivtfile,islndfile,ivtxname,ivtyname,pixelarea,timedef,undef,outfile,pixel_ivtpercentile_limits,global_ivtpercentile_limit,universal_ivt_limits,length_limit,lenwidratio_limit,ivtonly)
...
fprintf(1,' done.\n');
pixel_ivt_limit_outfile=fullfile(outdir,'pixel_ivt_limit.nc');
...
disp("No data on the equator or NH.");
end
...
fprintf(1,'Processing time step %i of %i ...',tcnt,ntime); tic_thisstep=tic;
else
